...
<!-- D E S T I N O S -->
    ...
    <div class="post-destino-general">
      <?php
                    global $post;
                    $class_actividades = 0;
                    $image_data = wp_get_attachment_image_src ( get_the_post_thumbnail( $post->ID), 'full' );
                    $image_url = $image_data[0];
                    $wp_query = new WP_Query(); $wp_query->query('showposts=12&cat=5' . '&paged='.$paged );
...
echo get_the_post_thumbnail_url( $post_id, 'large' ); ?>) center !important; background-size: cover !important;">
     ...
     <?php endwhile; ?>
           ...
           <a href="/destinos" class="button-vermas">Ver todos  </a>
